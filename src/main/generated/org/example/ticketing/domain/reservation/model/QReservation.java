...
public class QReservation extends EntityPathBase<Reservation> {
    ...
    private static final long serialVersionUID = 1093997569L;
    ...
    public final org.example.ticketing.domain.concert.model.QSeat seat;
    ...
    public QReservation(Class<? extends Reservation> type, PathMetadata metadata, PathInits inits) {
        ...
        this.seat = inits.isInitialized("seat") ? new org.example.ticketing.domain.concert.model.QSeat(forProperty("seat"), inits.get("seat")) : null;
